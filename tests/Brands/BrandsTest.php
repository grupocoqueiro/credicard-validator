...
class BrandsTest extends TestCase
{
    ...
    public function getNumbersFromAmex(): array
    {
        return [
            ...
            [new Card('370224246390429', '025', '03/2021')],
            [new Card('347708456324797', '123', '03/2021')],
            [new Card('373535788739302', '001', '03/2021')]
        ];
    }
    ...
    {
        return [
            [new Card('5536841163368573', '003', '03/2021')],
            [new Card('5126922761188005', '123', '03/2021')],
            [new Card('5365259185646718', '025', '03/2021')],
    ...
    {
        return [
            [new Card('4532098750298229', '021', '03/2021')],
            [new Card('4024007117652809', '123', '03/2021')],
            [new Card('4716444981564948', '123', '03/2021')],
            [new Card('4556341322221407', '003', '03/2021')],
    ...
    public function getNumbersFromDiners(): array
    {
        return [
            ...
            [new Card('30053342206979', '001', '03/2021')],
            [new Card('38152506174957', '123', '03/2021')],
            [new Card('30020059701955', '123', '03/2021')],
            [new Card('30395523414041', '025', '03/2021')],
